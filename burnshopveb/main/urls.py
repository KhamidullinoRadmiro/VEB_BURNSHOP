...
from .views import home, search_results, product_detail, product_list, product_edit, product_delete, product_add, register, user_login, user_logout, category_products
